---
title: "Experiment Pilot 4 Summary"
author: "Yetong Xu"
format: html
editor: visual
---
...
# Import data
pilot_data <- read_excel("Opt_Experiment_Pilot4.xlsx")

# Keep the rows from 474 to 635
pilot_data <- pilot_data[474:635, ]
...
In this section, we remove participants who send signals in Part 2 1) when the BuySignal is 75 tokens, 2) when the DefaultStatus is donated, BuySignal is 25 tokens, and they are wug donor, and 3) when the DefaultStatus is not donated, BuySignal is 25 tokens, and they are wug non-donor.
...
high_cost_people.write_csv("high_cost_people.csv")
