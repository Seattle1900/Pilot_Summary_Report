...
pilot_data <- pilot_data[716:1715, ]
...
summary_p2 <- pilot_data %>%
  ...
  summarise(
    p2q1_1 = sum(p2_q1 == '1', na.rm = TRUE),
    p2q1_2 = sum(p2_q1 == '2', na.rm = TRUE),
    p2q2_1 = sum(p2_q2 == '1', na.rm = TRUE),
    p2q2_2 = sum(p2_q2 == '2', na.rm = TRUE),
    p2q3_1 = sum(p2_q3 == '1', na.rm = TRUE),
    p2q3_2 = sum(p2_q3 == '2', na.rm = TRUE),
    n_total = n()
  ) %>%
...
pilot_data <- pilot_data %>%
  rowwise() %>%
  mutate(
    num_not_donate = sum(grepl("2", c_across(Screen_1_donated:Screen_6_notdonated), ignore.case = TRUE), na.rm = TRUE),
    num_donate = sum(grepl("1", c_across(Screen_1_donated:Screen_6_notdonated), ignore.case = TRUE), na.rm = TRUE)
  ) %>%
  ungroup()
...
screen_1 <- pilot_data %>%
  rowwise() %>%
  mutate(
    num_not_donate_screen1 = sum(grepl("2", c_across(Screen_1_donated:Screen_1_notdonated), ignore.case = TRUE), na.rm = TRUE),
    num_donate_screen1 = sum(grepl("1", c_across(Screen_1_donated:Screen_1_notdonated), ignore.case = TRUE), na.rm = TRUE)
  ) %>%
  ungroup()
...
screen_2 <- pilot_data %>%
  rowwise() %>%
  mutate(
    num_not_donate_screen2 = sum(grepl("2", c_across(Screen_2_donated:Screen_2_notdonated), ignore.case = TRUE), na.rm = TRUE),
    num_donate_screen2 = sum(grepl("1", c_across(Screen_2_donated:Screen_2_notdonated), ignore.case = TRUE), na.rm = TRUE)
  ) %>%
  ungroup()
...
screen_3 <- pilot_data %>%
  rowwise() %>%
  mutate(
    num_not_donate_screen3 = sum(grepl("2", c_across(starts_with("Screen_3")), ignore.case = TRUE), na.rm = TRUE),
    num_donate_screen3 = sum(grepl("1", c_across(starts_with("Screen_3")), ignore.case = TRUE), na.rm = TRUE)
  ) %>%
  ungroup()
...
screen_4 <- pilot_data %>%
  rowwise() %>%
  mutate(
    num_not_donate_screen4 = sum(grepl("2", c_across(Screen_4_donated:Screen_4_notdonated), ignore.case = TRUE), na.rm = TRUE),
    num_donate_screen4 = sum(grepl("1", c_across(Screen_4_donated:Screen_4_notdonated), ignore.case = TRUE), na.rm = TRUE)
  ) %>%
  ungroup()
...
screen_5 <- pilot_data %>%
  rowwise() %>%
  mutate(
    num_not_donate_screen5 = sum(grepl("2", c_across(Screen_5_donated:Screen_5_notdonated), ignore.case = TRUE), na.rm = TRUE),
    num_donate_screen5 = sum(grepl("1", c_across(Screen_5_donated:Screen_5_notdonated), ignore.case = TRUE), na.rm = TRUE)
  ) %>%
  ungroup()
...
screen_6 <- pilot_data %>%
  rowwise() %>%
  mutate(
    num_not_donate_screen6 = sum(grepl("2", c_across(Screen_6_donated:Screen_6_notdonated), ignore.case = TRUE), na.rm = TRUE),
    num_donate_screen6 = sum(grepl("1", c_across(Screen_6_donated:Screen_6_notdonated), ignore.case = TRUE), na.rm = TRUE)
  ) %>%
  ungroup()
...
pilot_data <- pilot_data %>%
  ...
  rowwise() %>%
  mutate(
    signal_sent = ifelse(p2_q1 == "1" | p2_q2 == "1" | p2_q3 == "1", 1, 0)
  ) %>%
  ungroup()
