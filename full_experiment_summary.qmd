...
pilot_data_cleaned <- pilot_data_cleaned %>%
  select("pid", "name_wug", "p2_q1", "p2_q2", "p2_q3", "Screen_1_donated", "Screen_1_notdonated", 
         "Screen_2_donated", "Screen_2_notdonated", starts_with("Screen_3"), "Screen_4_donated", 
         "Screen_4_notdonated", "Screen_5_donated", "Screen_5_notdonated", "Screen_6_donated", 
         "Screen_6_notdonated", "Assigned_Family", "DefaultStatus", "BuySignal", "OverturnCondition", 
         "wug_role", "num_not_donate", "num_donate", "moral_mean", "signal_sent", everything())
...
pilot_data_cleaned <- pilot_data_cleaned %>%
  mutate(
    ...
    p2_q1 = factor(p2_q1, levels = c(0, 1), labels = c("Not Send Signal", "Send Signal")),
    p2_q2 = factor(p2_q2, levels = c(0, 1), labels = c("Not Send Signal", "Send Signal")),
    p2_q3 = factor(p2_q3, levels = c(0, 1), labels = c("Not Send Signal", "Send Signal"))
  )
