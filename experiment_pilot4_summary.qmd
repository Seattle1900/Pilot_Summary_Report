...
In this section, we remove participants who send signals in Part 2, 1) when the DefaultStatus is donated, and they are wug donor, and 3) when the DefaultStatus is not donated, and they are wug non-donor.
